...
typedef int (*bplus_tree_range_callback)(key_t key, long data, void *context);
...
int bplus_tree_foreach_range(struct bplus_tree *tree, key_t key1, key_t key2,
                             bplus_tree_range_callback callback, void *context);
